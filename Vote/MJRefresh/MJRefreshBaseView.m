...
@interface  MJRefreshBaseView()
{
    ...
    __weak LoadingIconImageView *_activityView;
}
@end
 ...
 *  状态标签
 */
- (LoadingIconImageView *)activityView
{
    if (!_activityView) {
        LoadingIconImageView *activityView = [[LoadingIconImageView alloc] initWithFrame:CGRectMake(0, 0, 24, 24)];
