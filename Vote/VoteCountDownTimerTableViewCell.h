...
#define COUNTDOWN_CELL_PUBLIC_X                70.0  //COUNTDOWN_CELL_IMG_VIEW_X + COUNTDOWN_CELL_IMG_VIEW_WIDTH + 10
#define COUNTDOWN_CELL_PUBLIC_Y                10.0  //COUNTDOWN_CELL_IMG_VIEW_Y
#define COUNTDOWN_CELL_PUBLIC_WIDTH            20.0
#define COUNTDOWN_CELL_PUBLIC_HEIGHT           20.0
