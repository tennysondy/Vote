...
#define BDH_ADDRESS_IMG_TAG                     1008
#define BDH_ADDRESS_TEXT_TAG                    1009
#define BDH_TELEPHONE_IMG_TAG                   1010
#define BDH_TELEPHONE_TEXT_TAG                  1011
#define BDH_COMMENTS_AUTHOR_NAME_TAG            1012
#define BDH_COMMENTS_RATING_S_IMG_TAG           1013
#define BDH_COMMENTS_TEXT_TAG                   1014
...
#define BDH_NAME_FONT_SIZE                      16.0
...
//地址信息参数
#define BDH_ADDR_IMG_COORDINATE_X               10
#define BDH_ADDR_IMG_WIDTH                      30
#define BDH_ADDR_IMG_HEIGHT                     23
#define BDH_ADDRESS_COORDINATE_X                50
#define BDH_ADDRESS_COORDINATE_Y                10
#define BDH_ADDRESS_WIDTH                       [[UIScreen mainScreen] bounds].size.width - 60
#define BDH_ADDRESS_FONT                        @"ChalkboardSE-Regular"
#define BDH_ADDRESS_FONT_SIZE                   15
//电话列表参数
#define BDH_TELEPHONE_IMG_COORDINATE_X          10
#define BDH_TELEPHONE_IMG_WIDTH                 30
#define BDH_TELEPHONE_IMG_HEIGHT                28.5
#define BDH_TELEPHONE_COORDINATE_X              50
#define BDH_TELEPHONE_COORDINATE_Y              10
#define BDH_TELEPHONE_WIDTH                     [[UIScreen mainScreen] bounds].size.width - 60
#define BDH_TELEPHONE_FONT                      @"ChalkboardSE-Regular"
#define BDH_TELEPHONE_FONT_SIZE                 15
//团购列表参数
#define BDH_DEALS_IMG_COORDINATE_X              10
#define BDH_DEALS_IMG_WIDTH                     20
#define BDH_DEALS_IMG_HEIGHT                    20
#define BDH_DEALS_COORDINATE_X                  40
#define BDH_DEALS_COORDINATE_Y                  10
#define BDH_DEALS_WIDTH                         [[UIScreen mainScreen] bounds].size.width - 75
#define BDH_DEALS_FONT                          @"ChalkboardSE-Regular"
#define BDH_DEALS_FONT_SIZE                     13
//优惠券列表参数
#define BDH_COUPON_IMG_COORDINATE_X             10
#define BDH_COUPON_IMG_WIDTH                    20
#define BDH_COUPON_IMG_HEIGHT                   20
#define BDH_COUPON_COORDINATE_X                 40
#define BDH_COUPON_COORDINATE_Y                 10
#define BDH_COUPON_WIDTH                        [[UIScreen mainScreen] bounds].size.width - 75
#define BDH_COUPON_FONT                         @"ChalkboardSE-Regular"
#define BDH_COUPON_FONT_SIZE                    13
//评论列表参数
