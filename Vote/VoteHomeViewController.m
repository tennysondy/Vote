...
- (void)viewDidLoad
{
    ...
    [[UITabBarItem appearance] setTitleTextAttributes:@{NSFontAttributeName:[UIFont fontWithName:@"STHeitiSC-Medium" size:10.0f], NSForegroundColorAttributeName:UIColorFromRGB(0x27AAE1)} forState:UIControlStateSelected];
    UITabBarItem *item;
    ...
    [[UIBarButtonItem appearance] setTitleTextAttributes:@{NSForegroundColorAttributeName: [UIColor whiteColor], NSFontAttributeName:[UIFont systemFontOfSize:18.0f]} forState:UIControlStateNormal];
