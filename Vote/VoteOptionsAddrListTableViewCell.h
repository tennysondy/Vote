...
#define OALTVC_BUSINESS_NAME_WIDTH              205//团购和优惠都不存在
#define OALTVC_BUSINESS_NAME_WIDTH1             185//团购和优惠有1个存在
#define OALTVC_BUSINESS_NAME_WIDTH2             165//团购和优惠都存在
#define OALTVC_BUSINESS_NAME_HEIGHT             15
#define OALTVC_BUSINESS_NAME_FONT               @"Verdana"
#define OALTVC_BUSINESS_NAME_FONT_SIZE          15

//团购和优惠券
#define OALTVC_FIRSTVIEW_COORDINATE_X           275
#define OALTVC_FIRSTVIEW_COORDINATE_Y           10
#define OALTVC_FIRSTVIEW_WIDTH                  15
#define OALTVC_FIRSTVIEW_HEIGHT                 15

#define OALTVC_SECONDTVIEW_COORDINATE_X         295
#define OALTVC_SECONDTVIEW_COORDINATE_Y         10
#define OALTVC_SECONDTVIEW_WIDTH                15
#define OALTVC_SECONDTVIEW_HEIGHT               15
